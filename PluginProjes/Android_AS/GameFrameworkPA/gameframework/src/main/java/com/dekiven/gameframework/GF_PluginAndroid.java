...
public class GF_PluginAndroid extends Fragment {
    ...
    public static void noticeUnity(String eventName, String msg) {
        UnityPlayer.UnitySendMessage(sNoticeGameobjName, sNoticeFuncName, eventName + "__;__" + msg);
    }

    public void requestPermission(int code, boolean requestForce, IPermissionRequestCallback callback) {
        requestPermissions(new int[]{code,}, requestForce, callback);
    }

    public void requestPermission(String permission, int code, boolean requestForce, IPermissionRequestCallback callback) {
        requestPermissions(new String[]{permission,}, new int[]{code,}, requestForce, callback);
    }

    public void requestPermissions(int[] codes, boolean requestForce, IPermissionRequestCallback callback) {
        requestPermissions(getPermissionArray(codes), codes, requestForce, callback);
    }

    public void requestPermissions(String[] permissions, int[] codes, boolean requestForce, IPermissionRequestCallback callback) {
        sPerReCodes = codes;
        sRequestList.clear();
    ...
    private static void start() {
        ...
        //test
        instance.showToast("包名："+sPackageName);
    }
