...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		GameFramework_SingletonComp_GameFramework_GameResManagerWrap.Register(L);
		GameFramework_SingletonComp_GameFramework_GameLuaManagerWrap.Register(L);
		GameFramework_SingletonComp_GameFramework_GameManagerWrap.Register(L);
		L.EndModule();
