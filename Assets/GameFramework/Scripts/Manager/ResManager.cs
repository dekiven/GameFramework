...
namespace GameFramework
{
    ...
    public class ResManager : SingletonComp<ResManager>
    {
        ...
        //public void LoadPrefab(string abName, string name, LuaFunction luaFunc)
        //{
        //    LoadRes<GameObject>(abName, name, null, luaFunc);
        //}

        //public void LoadPrefab(string abName, string[] names, LuaFunction luaFunc)
        //{
        //    LoadRes<GameObject>(abName, names, null, luaFunc);
        //}

        //public void LoadString(string abName, string name, LuaFunction luaFunc)
        //{
        ...
        //public void LoadString(string abName, string[] names, LuaFunction luaFunc)
        //{
        //    LoadRes<TextAsset>(abName, names, null, luaFunc);
        //}

        //public void LoadBytes(string abName, string name, LuaFunction luaFunc)
        //{
        //    LoadBytes(abName, new string[] { name, }, luaFunc);
        //}

        //public void LoadBytes(string abName, string[] names, LuaFunction luaFunc)
        //{
