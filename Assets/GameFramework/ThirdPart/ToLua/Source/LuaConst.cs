...
{
    public static string luaDir = GameFramework.Tools.GetLuaSrcPath();                //lua逻辑代码目录
    public static string toluaDir = GameFramework.Tools.GetFrameworkPath() + "/ThirdPart/ToLua/ToLua/Lua";        //tolua lua文件目录
