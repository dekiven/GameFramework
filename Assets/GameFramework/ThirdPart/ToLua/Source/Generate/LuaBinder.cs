...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		GameFramework_LuaExportFuncsWrap.Register(L);
		GameFramework_UIHandlerDataWrap.Register(L);
		GameFramework_UIHandlerWrap.Register(L);
		...
		L.RegFunction("Action_ints", System_Action_ints);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GameFramework_UIBase_UIAnimResult(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<GameFramework.UIBase.UIAnimResult>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<GameFramework.UIBase.UIAnimResult>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_ints(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
