...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<int[]>), factory.System_Action_ints);
		...
		dict.Add(typeof(GameFramework.UIBase.UIAnimResult), factory.GameFramework_UIBase_UIAnimResult);
		...
		DelegateTraits<System.Action<int[]>>.Init(factory.System_Action_ints);
		...
		DelegateTraits<GameFramework.UIBase.UIAnimResult>.Init(factory.GameFramework_UIBase_UIAnimResult);
		...
		TypeTraits<System.Action<int[]>>.Init(factory.Check_System_Action_ints);
		...
		TypeTraits<GameFramework.UIBase.UIAnimResult>.Init(factory.Check_GameFramework_UIBase_UIAnimResult);
		...
		StackTraits<System.Action<int[]>>.Push = factory.Push_System_Action_ints;
		...
		StackTraits<GameFramework.UIBase.UIAnimResult>.Push = factory.Push_GameFramework_UIBase_UIAnimResult;
	...
	class System_Action_ints_Event : LuaDelegate
	{
		public System_Action_ints_Event(LuaFunction func) : base(func) { }
		public System_Action_ints_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public System.Action<int[]> System_Action_ints(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<int[]> fn = delegate(int[] param0) { };
		...
		if(!flag)
		{
			System_Action_ints_Event target = new System_Action_ints_Event(func);
			System.Action<int[]> d = target.Call;
			target.method = d.Method;
			return d;
		}
		...
		{
			System_Action_ints_Event target = new System_Action_ints_Event(func, self);
			System.Action<int[]> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	...
	bool Check_System_Action_ints(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<int[]>), L, pos);
	}

	void Push_System_Action_ints(IntPtr L, System.Action<int[]> o)
	{
		ToLua.Push(L, o);
	}
	...
	class GameFramework_UIBase_UIAnimResult_Event : LuaDelegate
	{
		public GameFramework_UIBase_UIAnimResult_Event(LuaFunction func) : base(func) { }
		public GameFramework_UIBase_UIAnimResult_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public GameFramework.UIBase.UIAnimResult GameFramework_UIBase_UIAnimResult(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			GameFramework.UIBase.UIAnimResult fn = delegate(bool param0) { };
			return fn;
		}

		if(!flag)
		{
			GameFramework_UIBase_UIAnimResult_Event target = new GameFramework_UIBase_UIAnimResult_Event(func);
			GameFramework.UIBase.UIAnimResult d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			GameFramework_UIBase_UIAnimResult_Event target = new GameFramework_UIBase_UIAnimResult_Event(func, self);
			GameFramework.UIBase.UIAnimResult d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_GameFramework_UIBase_UIAnimResult(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(GameFramework.UIBase.UIAnimResult), L, pos);
	}

	void Push_GameFramework_UIBase_UIAnimResult(IntPtr L, GameFramework.UIBase.UIAnimResult o)
	{
		ToLua.Push(L, o);
	}
